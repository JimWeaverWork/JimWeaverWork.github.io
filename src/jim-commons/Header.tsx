...
import { openResumeInNewTab } from "./Utils";
import { motion } from "framer-motion";

import { Link, useNavigate } from "react-router-dom";
import { useGetImages } from "./Hooks";
import { headerImages } from "./headerData";
import { getProject } from "../jim-main/projectsData";
import { getPost } from "../jim-blog/posts";
...
function Header() {
  ...
  const breadcrumbLabel = useMemo(() => {
    ...
    if (path.startsWith("/blog/")) {
      ...
      return getPost(slug)?.title ?? "Post";
    }
    if (["/work", "/education", "/blog", "/contact"].includes(path)) {
        ...
        <Toolbar variant="dense" disableGutters>
          <Stack direction="row" gap={1} alignItems="center">
            ...
            <StyledTooltip
              ...
              enterDelay={1500}
            >
              <StyledH2 onClick={handleHomeClick}>Jim Weaver</StyledH2>
            </StyledTooltip>
            <motion.div
          ...
          {!isPhone ? (
            ...
            >
              <div>
                ...
                >
                  <MenuItem
                    sx={{ fontSize: "0.9rem" }}
                    onClick={() => {
                      scrolldownToSection("tech stack");
                    }}
                  >
                    Tech Stack
                  </MenuItem>
              ...
              />
              <StyledChip
                icon={<Article sx={ChipIconWithTextStyle} />}
                label="Blog"
                onClick={() => {
                  navigate("/blog");
                }}
