...
import { DialogContext, type genericAppData } from "./appData";
  ...
  return isPhone ? (
    ...
    >
      ...
      >
        ...
        <CardContent>
          {/* A single title element slides from left to center on hover. The
              `layout` prop animates its real position (FLIP) as justifyContent
              flips, so it casually moves across rather than cross-fading a
              second copy,  and stays truly centered for any title width. */}
          <div
            style={{
              position: "relative",
              width: "100%",
